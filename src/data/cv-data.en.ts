...
export const cvDataEn: CVData = {
  personalInfo: {
    name: "Byron Gonzalez",
    title: "Business Analyst & Technical Lead",
  ...
  experience: [
    {
      ...
      technologies: ["Generative AI","Claude","Cursor","Windsurf","n8n","Supabase","Railway","Vercel","AWS (Solutions Architect Associates)","Cloud Architecture Design"]
    },
    {
